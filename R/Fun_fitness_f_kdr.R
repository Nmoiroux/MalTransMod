...
#' @param FUN the function used to calculate the number of oviposition events (default = `IC``)
#'
...
#' fitness_f_kdr(Pllin_kdr, m1p_kdr, m2p_kdr, IC)

fitness_f_kdr <- function(Pllin_kdr, m1p_kdr, m2p_kdr, FUN=IC){
